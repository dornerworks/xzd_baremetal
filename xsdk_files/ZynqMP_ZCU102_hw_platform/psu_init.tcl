...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0028 0x80000000 0x00000000
		# : DDR_PLL INIT
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0064 0x023F3F07 0x02010400
		...
		# 6 bit divider
		# PSU_CRL_APB_USB3_DUAL_REF_CTRL_DIVISOR0                                         0x4
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E004C, 0x023F3F07U ,0x02010400U)  */
    mask_write 0XFF5E004C 0x023F3F07 0x02010400
    ...
    mask_write 0XFF5E00A0 0x01003F07 0x01000200
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD0700EC 0xFFFF0000 0x081D0000
    ...
    mask_write 0XFD080198 0xFFFFFFFF 0x0000081D
    ...
    mask_write 0XFD080528 0xFFFFFFFF 0xF903202B
    ...
    mask_write 0XFD080004 0xFFFFFFFF 0x00040001
		# : POLL FOR DDR PHY
		# Register : PGSR0 @ 0XFD080030</p>
    ...
    mask_poll 0XFD080030 0x00000010
		# Register : DFIMISC @ 0XFD0701B0</p>
    ...
    mask_write 0XFD0701B0 0x00000001 0x00000001
		# Register : SWCTL @ 0XFD070320</p>
    ...
    mask_write 0XFD070320 0x00000001 0x00000001
		# : POLL FOR DDR INIT
    ...
    mask_poll 0XFD070004 0x00000007
		# : TRIGGER PHY TRAIN
		# : DDR PHY TRAIN
		# Register : PIR @ 0XFD080004</p>
    ...
    mask_write 0XFD080004 0xFFFFFFFF 0x0004FE01
		# : POLL FOR DDR PHY
		# Register : PGSR0 @ 0XFD080030</p>
    ...
    mask_write 0XFD080200 0xFFFFFFFF 0x110091C7
		# Register : PGCR2 @ 0XFD080018</p>
    ...
    mask_write 0XFD080018 0xFFFFFFFF 0x00F01EEE
    ...
    mask_write 0XFD08001C 0xFFFFFFFF 0x55AA0098
		# Register : DX8SL0DXCTL2 @ 0XFD08142C</p>
    ...
    mask_write 0XFD08142C 0xFFFFFFFF 0x00001830
		# Register : DX8SL1DXCTL2 @ 0XFD08146C</p>
    ...
    mask_write 0XFD08146C 0xFFFFFFFF 0x00001830
		# Register : DX8SL2DXCTL2 @ 0XFD0814AC</p>
    ...
    mask_write 0XFD0814AC 0xFFFFFFFF 0x00001830
		# Register : DX8SL3DXCTL2 @ 0XFD0814EC</p>
    ...
    mask_write 0XFD0814EC 0xFFFFFFFF 0x00001830
		# Register : DX8SL4DXCTL2 @ 0XFD08152C</p>
    ...
    mask_write 0XFD08152C 0xFFFFFFFF 0x00001830
		# : POLL FOR DDR PHY
		# Register : PGSR0 @ 0XFD080030</p>
    ...
    mask_write 0XFD08001C 0xFFFFFFFF 0x55AA0080
		# Register : DX8SL0DXCTL2 @ 0XFD08142C</p>
    ...
    mask_write 0XFD070180 0xF7FF03FF 0x01000040
		# Register : RFSHCTL3 @ 0XFD070060</p>
    ...
    mask_write 0XFD070060 0x00000073 0x00000000
}
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x7FFFFFFF 0x06240000
    ...
    mask_write 0XFF18013C 0x03FFFFFF 0x00000000
    ...
    mask_write 0XFF180158 0x03FFFFFF 0x00000000
    ...
    mask_write 0XFF180174 0x03FFFFFF 0x00000000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD480228 0x00070000 0x00060000
    ...
    mask_write 0XFF4B0024 0x000000FF 0x00000000
		# : CSU TAMPERING
		# : CSU TAMPER STATUS
...
proc psu_init {} {
    ...
    init_ps [subst {$psu_mio_init_data $psu_pll_init_data $psu_clock_init_data $psu_ddr_init_data $psu_peripherals_init_data $psu_peripherals_powerdwn_data $psu_security_data}]
}
...
proc  serdes_fixcal_code {} {
   ...
   set tmp_0_1 [mrd -force -value 0xFD400CB4]
   ...
   mask_write 0xFD40EC48 0xFFFFFFFF $tmp_0_3

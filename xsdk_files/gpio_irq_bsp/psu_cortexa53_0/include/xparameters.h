...
#if GUEST
#define XPAR_PSU_ACPU_GIC_BASEADDR 0x03002000			//0xF9060000			// Xen maps the GICC interface to 0x03002000 from 0xF9060000
#define XPAR_PSU_ACPU_GIC_HIGHADDR 0x03002fff			//0xF9060FFF
#define XPAR_PSU_ACPU_GIC_DIST_BASEADDR 0x03001000 //0xF9010000					// Xen maps the GICD itnerface to 0x03001000 from 0xF9010000
